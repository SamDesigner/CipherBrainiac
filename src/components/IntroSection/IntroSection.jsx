...
const IntroSection = () => {
  return (
    <div className="max-w-[1440px] mx-auto px-[16px] lg:px-[80px] flex flex-col md:flex-row gap-[40px] lg:gap-[130px] py-[40px] md:py-[80px] ">
      <div className="flex-1 h-auto flex ">
        <IntroVideo />
      </div>
      <div className="flex-1 flex flex-col gap-[10px]">
        <h1 className="text-red-700 font-[600] text-[25px] lg:text-[30px]">Bringing Out Your Best Version</h1>
